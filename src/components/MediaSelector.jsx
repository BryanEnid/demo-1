...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@/chadcn/Card';
import { Typography } from '@/chadcn/Typography';

export function MediaSelector({ onChange }) {
				...
				<CardContent>
					<div className="flex flex-col justify-center items-center gap-4">
						<div className="bg-white/40 rounded-full p-4">
							<Icon icon="fluent:live-24-regular" className="text-slate-800 text-7xl" />
						</div>

						<div>
							<Typography variant="large">Go live</Typography>
							<Typography variant="small">Supports VR and 360 videos</Typography>
						</div>
					</div>
				</CardContent>
			</Card>
				...
				<CardContent>
					<div className="flex flex-col justify-center items-center gap-4">
						<div className="bg-slate-300/20 rounded-full p-4">
							<Icon icon="line-md:upload-loop" className="text-slate-800 text-5xl" />
						</div>

						<Typography variant="small">Drag and drop video files to upload</Typography>
				...
				<CardContent>
					<div className="flex flex-col justify-center items-center gap-4">
						...
						<div>
							...
							<Typography variant="small">Peripherals or Screen record</Typography>
						</div>
					</div>
				</CardContent>
			</Card>

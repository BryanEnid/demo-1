...
const { faVolumeMute, faVolumeUp, faPause, faPlay, faGripLinesVertical, faSync, faStepBackward, faStepForward, faCamera, faDownload, faEraser } = {
  faVolumeMute: "",
...
function Editor({ videoUrl, timings, setTimings }) {
  ...
  const addActiveSegments = () => {
    ...
    for (let times of timings) {
      if (counter > 0) {
        colors += `, rgb(240, 240, 240) ${(timings[counter].end / playVideoRef.current.duration) * 100}%, rgb(240, 240, 240) ${
    ...
    <div className="wrapper">
      ...
      <div className="controls">
        <div className="player-controls">
          ...
          <button className="settings-control" title="Mute/Unmute Video" onClick={() => setIsMuted({ isMuted: !isMuted })}>
